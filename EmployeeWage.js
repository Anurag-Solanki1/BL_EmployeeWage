...
const totalWage = [...empDailyWageMap.values()].reduce(
...
let fullTimeDays = [...empDailyWageMap]
...
let daysWorked = [...empDailyWageMap.values()].filter(
  (wage) => wage > 0
).length;
